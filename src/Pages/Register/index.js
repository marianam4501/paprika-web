export default function Register() {
  return (
    <div className="w-screen h-screen">
      <div className="w-screen h-20 items-center justify-center bg-black sm:px-4 md:px-8 lg:px-16">
        <img
      ...
      <div className="w-auto h-full items-center justify-center flex">
        <div className="mb-4">
          ...
          <form >
            <div className="mb-4">
              <label>
                ...
                <br />
                <input
                  className="placeholder:text-gray-400 placeholder:text-sm p-4 h-[28px] w-[250px] border-[1px] rounded border-black "
